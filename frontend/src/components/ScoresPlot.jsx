...
//It shows the output distribution of the scores that are calculated based on the designed ASF
class ScoresPlot extends React.Component {
    constructor(props) {
        super(props)
